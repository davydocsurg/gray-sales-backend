...
// $ExpectType Promise<ResourceApiResponse>
cloudinary.v2.api.resources_by_asset_ids(
    ["asset_1", "asset_2"],
    {
        context: true,
        tags: true,
...
// $ExpectType Promise<any>
cloudinary.v2.api.search("search input", function (error, result) {
    console.log(result);
});
...
cloudinary.v2.uploader
    .update_metadata({ metadata_color: "red", metadata_shape: "" }, [
        "test_id_1",
        "test_id_2",
    ])
    .then((res) => {
...
cloudinary.v2.uploader.update_metadata(
    'countryFieldId=["id_us","id_uk","id_france"]',
    ["dog", "lion"],
    function (error, result) {
        console.log(result, error);
    }
